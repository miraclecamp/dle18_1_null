...
if($_POST['action'] == "create") {
	...
	if ($type == "tpl") {
		$script= <<<HTML
<script>
  var editor = code_editor('#file_text', {height: '100%', useWorker: false, beautify: false});
</script>
HTML;
	...
	if ($type == "css") {
		$script= <<<HTML
<script>
   var editor = code_editor('#file_text', {mode: 'ace/mode/css', height: '100%'});
</script>
HTML;
	...
	if ($type == "js") {
		$script= <<<HTML
<script>
  var editor = code_editor('#file_text', {mode: 'ace/mode/javascript', height: '100%'});
</script>
HTML;
	...
	echo <<<HTML
<br><br><div style="direction: ltr;border: solid 1px #ddd;width:100%;height:28rem;"><textarea style="width:100%;height:440px;" name="file_text" id="file_text" wrap="off">{$content}</textarea></div>
